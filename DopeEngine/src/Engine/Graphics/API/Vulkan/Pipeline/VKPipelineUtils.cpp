...
{
	VkPrimitiveTopology VKPipelineUtils::get_vk_primitive_topology(const PrimitiveTopology primitives)
	{
		switch (primitives)
		{
	...
	VkCullModeFlags VKPipelineUtils::get_vk_cull_mode(const FaceCullMode cullMode)
	{
		switch (cullMode)
		{
	...
	VkFrontFace VKPipelineUtils::get_vk_front_face(const FrontFaceMode frontFace)
	{
		switch (frontFace)
		{
	...
	VkPolygonMode VKPipelineUtils::get_vk_polygon_mode(const PolygonFillMode polygonFillMode)
	{
	...
	VkShaderStageFlagBits VKPipelineUtils::get_vk_shader_stage(const ShaderType shaderType)
	{
		switch (shaderType)
		{
